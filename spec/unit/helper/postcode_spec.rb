describe Helper::Postcode, type: :helper do
  ...
  context "when validating postcode with invalid postcodes" do
    ...
    it "raises PostcodeNotValid as inward code is not in the right format" do
    ...
    it "raises PostcodeNotValid for a postcode not starting with a letter" do
      expect { described_class.validate("1GA 3DD") }.to raise_error(Errors::PostcodeNotValid)
    end
  end
end
